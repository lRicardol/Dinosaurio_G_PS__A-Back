...
//import com.dinosurio_G.Back.service.DistributedCacheService;
...
//    @Mock private DistributedCacheService distributedCache;
//
//    @InjectMocks
...
//
//        // 🔥 NUEVOS MOCKS OBLIGATORIOS 🔥
//        when(distributedCache.getRoom("ABC123")).thenReturn(null); // Forzar carga desde DB
//        doNothing().when(distributedCache).saveRoom(eq("ABC123"), any()); // Evitar NullPointer
//    }
//
//
//
...
//        p.setUserAccount(ua);
//
//        // Asegurar Redis devuelve la sala
//        when(distributedCache.getRoom("ABC123"))
//                .thenReturn(room);
//
//        // Mock XP service
//        when(xpService.resetRoomXp("ABC123"))
//                .thenReturn(true);
//
//        // Ejecutar victoria con winnerId=1 y lista vacía
//        gameplay.onGameWon("ABC123");
//
//        // UserAccount.endSession() debe ejecutarse
//        verify(ua, times(1)).endSession();
//
//        // El jugador debe ser reseteado
...
//
//        // El juego ya no debe estar iniciado
//        assertFalse(room.isGameStarted());
//
//        // Y la sala debe ser eliminada del cache (Redis)
//        verify(distributedCache, times(1)).deleteRoom("ABC123");
//    }
//
//
//    // ------------------------------------------------
